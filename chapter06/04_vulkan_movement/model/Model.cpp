...
void Model::init() {
  ...
  mVertexData.vertices[0].color = glm::vec3(0.5f, 0.5f, 0.5f);
  mVertexData.vertices[1].color = glm::vec3(0.5f, 0.5f, 0.5f);
  mVertexData.vertices[2].color = glm::vec3(0.5f, 0.5f, 0.5f);
  mVertexData.vertices[3].color = glm::vec3(0.5f, 0.5f, 0.5f);
  mVertexData.vertices[4].color = glm::vec3(0.5f, 0.5f, 0.5f);
  mVertexData.vertices[5].color = glm::vec3(0.5f, 0.5f, 0.5f);
  ...
  mVertexData.vertices[6].color = glm::vec3(0.5f, 0.5f, 0.5f);
  mVertexData.vertices[7].color = glm::vec3(0.5f, 0.5f, 0.5f);
  mVertexData.vertices[8].color = glm::vec3(0.5f, 0.5f, 0.5f);
  mVertexData.vertices[9].color = glm::vec3(0.5f, 0.5f, 0.5f);
  mVertexData.vertices[10].color = glm::vec3(0.5f, 0.5f, 0.5f);
  mVertexData.vertices[11].color = glm::vec3(0.5f, 0.5f, 0.5f);
  ...
  mVertexData.vertices[12].color = glm::vec3(0.5f, 0.5f, 0.5f);
  mVertexData.vertices[13].color = glm::vec3(0.5f, 0.5f, 0.5f);
  mVertexData.vertices[14].color = glm::vec3(0.5f, 0.5f, 0.5f);
  mVertexData.vertices[15].color = glm::vec3(0.5f, 0.5f, 0.5f);
  mVertexData.vertices[16].color = glm::vec3(0.5f, 0.5f, 0.5f);
  mVertexData.vertices[17].color = glm::vec3(0.5f, 0.5f, 0.5f);
  ...
  mVertexData.vertices[18].color = glm::vec3(0.5f, 0.5f, 0.5f);
  mVertexData.vertices[19].color = glm::vec3(0.5f, 0.5f, 0.5f);
  mVertexData.vertices[20].color = glm::vec3(0.5f, 0.5f, 0.5f);
  mVertexData.vertices[21].color = glm::vec3(0.5f, 0.5f, 0.5f);
  mVertexData.vertices[22].color = glm::vec3(0.5f, 0.5f, 0.5f);
  mVertexData.vertices[23].color = glm::vec3(0.5f, 0.5f, 0.5f);
  ...
  mVertexData.vertices[24].color = glm::vec3(0.5f, 0.5f, 0.5f);
  mVertexData.vertices[25].color = glm::vec3(0.5f, 0.5f, 0.5f);
  mVertexData.vertices[26].color = glm::vec3(0.5f, 0.5f, 0.5f);
  mVertexData.vertices[27].color = glm::vec3(0.5f, 0.5f, 0.5f);
  mVertexData.vertices[28].color = glm::vec3(0.5f, 0.5f, 0.5f);
  mVertexData.vertices[29].color = glm::vec3(0.5f, 0.5f, 0.5f);
  ...
  mVertexData.vertices[30].color = glm::vec3(0.5f, 0.5f, 0.5f);
  mVertexData.vertices[31].color = glm::vec3(0.5f, 0.5f, 0.5f);
  mVertexData.vertices[32].color = glm::vec3(0.5f, 0.5f, 0.5f);
  mVertexData.vertices[33].color = glm::vec3(0.5f, 0.5f, 0.5f);
  mVertexData.vertices[34].color = glm::vec3(0.5f, 0.5f, 0.5f);
  mVertexData.vertices[35].color = glm::vec3(0.5f, 0.5f, 0.5f);
